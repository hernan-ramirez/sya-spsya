...
<TR>
		<TD colspan="2" class="Gray1"><B>Amonestados</B></TD>
</TR>
<tr> 
  <TD class="GreenLeft">Nombre</td>
  <TD width="80" align="center" class="TerraLeft"><b>&nbsp;Tarjetas&nbsp;</b></td>
</tr>
<?
$sql = "
		SELECT t.tarjeta, t.id_jugador, j.nombre, j.apellido , COUNT(t.id_jugador) as tarj
		FROM futbol_tarjetas t
			LEFT JOIN futbol_jugadores j ON (t.id_jugador = j.id)
			LEFT JOIN futbol_partidos fp ON (t.id_partido = fp.id)		
...
?>
<tr> 
	<td class="Green<? echo $estilo ?>"><? echo $row["apellido"] ?>, 
		<? echo $row["nombre"] ?> </td>
	<td align="center" class="Terra<? echo $estilo ?>"><? echo $row["tarj"] ?></td>
</tr>
<?
} 
	}
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	<TR> 
		<TD colspan="2" class="Gray1"><B>Expulsados</B></TD>
	</TR>
	<tr> 
		<TD class="GreenLeft">Nombre</td>
		<TD width="80" align="center" class="TerraLeft"><b>&nbsp;Tarjetas&nbsp;</b></td>
