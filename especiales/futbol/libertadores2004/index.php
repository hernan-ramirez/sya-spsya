...
if(!isset($id_estruc)){ $id_estruc = 86; }
if(!isset($id_torneo)){ $id_torneo = 9; }
...
<HTML>
<HEAD>
<TITLE> Copa Libertadores 2004 </TITLE>
    ...
    <TR>
		...
		<TD valign="top" bgcolor="#FFFFFF">
			<table width="468" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<td><IMG src="img/h_c_libertadores.gif" width="468" height="63"></td>
				</tr>
				<tr> 
					<td class="BackSolapasEspecialesLibertadores"><? include $common."menu.inc.php" ?></td>
				</tr>
				<tr> 
					<td> 
