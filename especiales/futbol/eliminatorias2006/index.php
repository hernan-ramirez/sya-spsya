...
if(!isset($id_estruc)){ $id_estruc = 58; }
if(!isset($id_torneo)){ $id_torneo = 2; }
...
<HTML>
<HEAD>
<TITLE> Eliminatorias Sudamericanas 2006 </TITLE>
    ...
    <TR>
		...
		<TD valign="top" bgcolor="#FFFFFF">
			<table width="468" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<td><IMG src="img/h_elim2006.gif" width="468" height="66"></td>
				</tr>
				<tr> 
					<td class="BackSolapasEspecialesEli"><? include $common."menu.inc.php" ?></td>
				</tr>
				<tr> 
					<td> 
